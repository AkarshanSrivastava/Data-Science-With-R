...
### 1 outlier in virginica
which(iris$Sepal.Length<5)
##row 107 contain sepallength 4.9 but in real time it not effected so we will not remove it
###
iris[107,1]=5.8
View(iris)
##remove outlier
##when we again run the code so find there is no outlier
mean(iris$Sepal.Length)
median(iris$Sepal.Length)

###outlier not effected the data 
