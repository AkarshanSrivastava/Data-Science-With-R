fraud <- read.csv("C://Users//Acer//Desktop//Assignment//complete//DECISION TREE//Fraud_check.csv")
View(fraud)
####EDA##
...
##80
##very good model
CrossTable(predict6,test1$Taxable.Income)
...
CrossTable(predict8,test1$Taxable.Income)
##80
